...
<body class="">
    ...
    <style>
        ...
        .team_desc {
            ...
            padding: 20px;
            overflow: hidden;
            box-shadow: 0 0 1rem 0 rgba(136, 152, 170, .15) !important;
        }
                ...
                <div class="w-embed w-script">
                    <div class="hbspt-form" id="hbspt-form-1623741844431-9103338542">
                        <form action="frontend/addNewAppointment" id="sendEmail" class="addAppointmentForm" enctype="multipart/form-data" method="POST">
                            ...
                            <input type="hidden" name="onlinecenter_id" id="onlinecenter_id" value="<?php echo $onlinecenter_id; ?>">
                            <input type="hidden" name="casetaker_id" id="casetaker_id" value="<?php echo $casetaker_id; ?>">
                            ...
                            <input type="hidden" name="redirect" value="frontend/hospitalAppointmentLink?id=<?php echo $hospital->id; ?><?php if (!empty($onlinecenter_id)) {
                            ...
                            <div class="col-md-12 mb-4 hidden">
                                ...
                                <input type="hidden" id="selectedHospital" name="hospital" value="<?php echo $hospital->id ?>">

                            </div>
                            <input type="hidden" name="hospital" id="hospital_id" value="<?php echo $hospital->id ?>">
                            ...
                            <!-- <div class="col-md-12 mb-4">
                                <div class="" id="">
                                    <label for="exampleInputEmail1" style="margin-left: -15px; margin-bottom: 20px;"> Appointment Type</label>


                                    <select class="form-control m-bot15 select_board" name="medical_board_type" id="select_board" value=''>
                                        <option value="Single Doctor"> Single Doctor Appointment </option>
                                        <option value="Medical Board"> Medical Board Appointment</option>
                                        <option value="Custom Board"> Custom Board Appointment</option>
                            ...
                            <div class="col-md-12 mb-4 single_appointment">
                                <div class="" id="adoctors">
                                    ...
                                    <div class="hospitalDocs row category">
                                ...
                                <div class="" id="">
                                    ...
                                    <div class="col-md-12" style="margin-top: 20px; margin-left: -12px;">
                                        ...
                                        <select class="form-control m-bot15 my_select1_disabledd" id="" multiple="multiple" name="custom_board_doctor[]" value=''>
                                            ...
                                            ?>
                                                <option value="<?php echo $doctor->id; ?>" data-price="<?php if (!empty($price->individual_medical_board_visit_charges)) {
                                                                                                            echo $price->individual_medical_board_visit_charges;
                                                                                                        } else {
                                                                                                            echo 0;
                                                                                                        } ?>" <?php
                                                                                                                if (!empty($team->id)) {
                                    ...
                                    <label id="label-lastname-93389280-7d5f-4a00-a4a2-6b177ad9e886" style="font-weight: bold; margin: 20px 0px;">
                                        ...
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <div class="col-md-11"> <label for=""> <?php echo lang('courier'); ?></label><br></div>
                                                        ...
                                                        <label style="margin-bottom: 20px; margin-top:40px;"><?php echo lang('visit'); ?> <?php echo lang('description'); ?></label>
            ...
            success: function(response) {
                ...
                if (slots.length == 0) {
                    ...
                    $.each(slots, function(key, value) {
                        ...
                        html += '<div class="col-md-4"><div id="hospital" data-id="' + value.id + '" class="hospital green hosp appDoc boxborder"><div class="col-sm-4 image2"><img src="' + value.img_url + '" class="image" ><p >Country : <span class="txtt">' + value.country + '</span></p><p>Visit Type : <span class="txtt">' + place + '</span></p></div><div class="col-sm-8 text-1"> <span>' + value.name + '</span><span class="txt">' + value.profile + ' </span></div></div></div>';
                    });
