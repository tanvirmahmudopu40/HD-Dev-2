                ...
                <div class="w-embed w-script">
                    <div class="hbspt-form" id="hbspt-form-1623741844431-9103338542">
                        <form action="frontend/addNewAppointment" id="sendEmail" class="addAppointmentForm" enctype="multipart/form-data" method="POST">
                            ...
                            <input type="hidden" name="redirect" value="frontend/medicalBoardAppointmentLink?id=<?php echo $team->id; ?><?php if (!empty($onlinecenter_id)) {
                                                                                                                                            echo '&onlinecenter_id=' . $onlinecenter_id;
                                                                                                                                        } ?><?php if (!empty($casetaker_id)) {
                                                                                                                                                echo '&casetaker_id=' . $casetaker_id;
                                                                                                                                            } ?>">

                            <input type="hidden" name="hospital" id="hospital_id" value="<?php echo $team->hospital_id ?>">

                            <input type="hidden" id="selectedDoctor" value="<?php echo $team->lead_doctor ?>" name="doctor">
                            <input type="hidden" id="doctor_id" value="<?php echo $team->lead_doctor ?>" name="doctor">
                                    ...
                                    <div class="row doc_desc">
                                        <div class="col-md-12 panel" style="margin-top: 20px; margin-left: -12px;">
                                            <div class="col-md-6 hidden">
                                                <label for="exampleInputEmail1"> Medical Board Type </label>
                                            ...
                                            <div class="medical_team">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="hidden" name="team" id="board_id" value="<?php echo $id ?>">
                                                    <span class="form-control"> <?php echo $team->name; ?></span>
                                                </div>
                                            ...
                                            <div class="custom_board">
                                                <div class="col-md-12">
                                                    <label for="exampleInputEmail1">Custom Board </label>
                                                    <select class="form-control m-bot15" id="my_select1_disabledd" multiple="multiple" name="custom_board_doctor[]" value=''>
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="row details">
                                    <div class="col-md-4">
                                        ...
                                        <?php $team_details = $this->team_model->getTeamById($id); ?>
                                        <div class="">
                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                <div class="fileupload-new thumbnail img_class">
                                                    <img style="margin-bottom: 20px; width:400px height:500px;" src="<?php echo $team_details->img_url ?>" id="" alt="" />
                                                    <div style="margin-left: 20px;"><?php echo $team_details->name ?></div>
                                                    <!-- <div style="margin-left: 20px;"><?php echo $team_details->description ?></div> -->
                                                </div>
                                            </div>

                                        </div>
                                        <?php $doctor_id = explode(",", $team->doctor);
                                        foreach ($doctor_id as $key => $value) {
                                            $doctor_details = $this->doctor_model->getDoctorById($value); ?>
                                            <div class="">
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail img_class">
                                                        <img style="margin-bottom: 20px; height:200px;" src="<?php echo $doctor_details->img_url ?>" id="" alt="" />
                                                        <div style="margin-left: 20px;"><?php echo $doctor_details->name ?></div>
                                                        <div style="margin-left: 20px;"><?php echo $doctor_details->profile ?></div>
                                                        <div style="margin-left: 20px;">Country : <span style="color:green;"><?php echo $doctor_details->country ?></span></div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <div id="visiting_place_list">
                                                    ...
                                                    <!-- <div class="form-group col-md-6 pay_for_courier" style="margin-top: 20px; margin-bottom: 0px;">
                                                    ...
                                                    <div class="form-group pay_for_courier" style="margin-top: 20px; margin-bottom: 0px;">
                                                        <table style="width: 100%;">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="col-md-12 td" id="">
                                                                        <input style="border:none" type="number" class="form-control" name="appointment_subtotal" id="new_subtotal_fee" value='<?php
                                                                                                                                                                                                if (!empty($appointment->id)) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="col-md-12 td"><input style="border:none; width:100px;" type="number" class="form-control" name="visit_charges" id="total_charges" value='<?php
                                                                                                                                                                                                                            if (!empty($appointment->id)) {
                                                                                                                                                                                                                                echo $appointment->visit_charges;
                                                                                                                                                                                                                            }
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="" id="">
                                    <label for="exampleInputEmail1" style="margin-left: -15px; margin-bottom: 20px;"> <?php echo lang('description'); ?></label>
                                    <div class="row doc_desc">

                                        <div id="board_description"></div>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                let html = '';
                if (slots.length == 0) {
                    $('.hospitalDocs').append('<div class="col-md-12 text-center">No Doctor Found!</div>').end();
                } else {
                    $.each(slots, function(key, value) {
                        ...
                        html += '<div class="col-md-4"><div id="hospital" data-id="' + value.id + '" class="hospital green hosp appDoc boxborder"><div class="col-sm-3 image2"><img src="' + value.img_url + '" class="image" ></div><div class="col-sm-9 text-1"> <span>' + value.name + '</span><span class="txt">' + value.profile + ' </span></div></div></div>';
                    });
        ...
        $(document).on("click", ".appDoc", function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#doctor_name').append(response.response.name + ' ' + designation + ' <br> ' + 'Chamber Address :' + ' <br>' + chamber + '<br> ' + 'Country :' +
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                var description = response.response.description
                // var visit = response.response.total_board_visit
                $('#board_description').append(description).end();
                $("#image").attr("src", "uploads/demoavt.jpg");
                if (typeof response.response.img_url !== 'undefined' && response.response.img_url !== '') {
                    $("#image").attr("src", response.response.img_url);
                }
...
<script>
    $(document).ready(function() {
        ...
        $("#my_select1_team_disabled").select2({
            ...
            allowClear: true,
            ajax: {
                url: "frontend/getTeamNamelist?id=" + hospital_id,
                type: "post",
                dataType: 'json',
                delay: 250,
...
<script>
    $(document).ready(function() {
        ...
        $('#pos_select1').select2({
            ...
            closeOnSelect: true,
            ajax: {
                url: 'frontend/getPatientForBoard',
                dataType: 'json',
                type: "post",
                delay: 250,
                data: function(params) {
